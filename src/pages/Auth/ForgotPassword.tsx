...
export function ForgotForm() {
  const { mutateAsync: sendLinkTo, isPending, isSuccess } = useForgotPassword();
  ...
  return (
    <Fieldset.Root mx={"auto"} maxW={300}>
      <Fieldset.Legend fontSize={"2xl"}>Forgot your password?</Fieldset.Legend>
      <Fieldset.HelperText>
        Enter the email associated with the account below to receive a reset
        link.
      </Fieldset.HelperText>
      <Fieldset.Content>
